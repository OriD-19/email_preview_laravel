    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="details">
                ...
                <p><strong>Estado del Pago:</strong> {{ $orderState }}</p>
            </div>
